...
- Proofread entries labeled "CAPTION", "CERTIFICATE", and "HEADING" with the same spelling, grammar, homophone, and steno-error checks as testimony. These pages are filed with the court and often contain the same class of typos (e.g., "da0y" for "day", "FRIEDN" for "FRIEND").
- On CAPTION / CERTIFICATE / HEADING entries: fill-in blanks are intentional and correct. Do NOT flag underscores ("_", "__", "___", longer runs), empty brackets ("[]", "[ ]"), blank date/signature lines, or placeholder time slots (e.g. "00 HOURS:00 MINUTES") as missing words, extra words, or incomplete sentences. Do NOT invent words to fill blanks (including "DIRECT", dates, or names). Do NOT suggest replacing "[]" with underscores or the reverse. Still flag clear typos in the surrounding filled-in words (e.g. "da0y" → "day", "FRIEDN" → "FRIEND").
- Skip entries with speaker labels: "INDEX", "EXHIBITS" — table-of-contents and exhibit-list formatting is out of scope.
